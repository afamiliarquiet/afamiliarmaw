...
public class MawEntities {
    ...
    public static final EntityType<BreathProjectileEntity> BREATH_PROJECTILE_TYPE = EntityType.Builder.<BreathProjectileEntity>create(BreathProjectileEntity::new, SpawnGroup.MISC)
